...
# Aryan's Elevator:
#
# Use W and S to select differnt floors, use up and down arrow to press up or down button on selected floor,
# Use Number keys to select floor buttons that are inside of elevator,
#
# Enjoy!
#
...
def drawinsidebuttons(buts):
    for count, each in enumerate(buts):
        ...
        if count + 1 != 10:
            ...
            font = pygame.font.Font('freesansbold.ttf', 25)
            text = font.render(f"{count + 1}", False, (0, 255, 255))
            screen.blit(text, (528, ((count + 1) * 70) - 35))
...
def drawcurentfloor(floor, direction):
    ...
    if direction == 1:
        pygame.draw.polygon(screen, (0, 255, 0),
                            ((610, 500), (630, 500), (630, 450), (640, 450), (620, 410), (600, 450), (610, 450)))
    if direction == 2:
        pygame.draw.polygon(screen, (255, 0, 0),
                            ((610, 550), (630, 550), (630, 600), (640, 600), (620, 640), (600, 600), (610, 600)))
...
while True:
    ...
    if diroftvl == 1:
        ...
        for each in qeue:
            if len(each) != 1:
                if (hieghts[each[0] - 1] - 50 < y and each[1] == 1) or (
                        hieghts[each[0] - 1] - 50 < y and each[1] == 0) or (
                        hieghts[each[0] - 1] - 50 < y and each[1] == 3):
                    counthigher += 1
        for each in qeue:
            if len(each) != 1:
                if (hieghts[each[0] - 1] - 50 == y):
    ...
    if diroftvl == 2:
        ...
        for each in qeue:
            if len(each) != 1:
                if (hieghts[each[0] - 1] - 50 > y and (each[1] == 0 or each[1] == 3)) or (
                        hieghts[0] - 50 > y and buttonspress[len(buttonspress) - 1][0] == 1):
                    countlower += 1
